...
class LoginActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        create_user_in_button.setOnClickListener {  attemptLogin(true) }
     ...
     */
    private fun attemptLogin( isCreateUser: Boolean = false ) {
    ...
    override fun onCreateLoader(i: Int, bundle: Bundle?): android.support.v4.content.Loader<Cursor> {
        return android.support.v4.content.CursorLoader(this,
    ...
    override fun onLoadFinished(p0: android.support.v4.content.Loader<Cursor>, cursor: Cursor) {
